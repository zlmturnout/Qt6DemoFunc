...
# import UI file
from UI.UI_DataViewPlot import Ui_Dialog
# import my own matplotlib InitialPlot
from Tools.My_Matplotlib_PySide6 import Myplot, InitialPlot, NavigationToolbar, MonitorPlot
# import my tool functions for usage
from Tools.Tools_functions import get_datetime, my_logger, creatPath, suppress_error, log_exception, log_exceptions, deco_count_time
import pandas as pd
# import class to display pandas dataFrame data
from Tools.Class_Pandas_data_QTable import PandasInQTable
#from Dependant.Class_Pandas_data_QTable import PandasInQTable
from UI.QtforPython_useful_tools import MyMsgBox
log_path = os.path.join(os.getcwd(), 'DataViewPlot','log_info')
creatPath(log_path)

# logger
log_file = f'{time.strftime("%Y-%m-%d", time.localtime())}.log'
logger = my_logger(log_file=os.path.join(log_path, log_file), logger_name='author')
